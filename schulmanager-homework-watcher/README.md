...
- **UGREEN NAS** mit **UGOS Pro**, Docker-App und x86-64-/AMD64-Prozessor
- Linux-Server mit Docker / Docker Compose und x86-64-/AMD64-Prozessor

Das veröffentlichte Docker-Hub-Image ist derzeit für `linux/amd64` verfügbar.
