...
- **UGREEN NAS** mit **UGOS Pro**, Docker-App und AMD64- oder ARM64-Prozessor
- Linux-Server mit Docker / Docker Compose und AMD64- oder ARM64-Prozessor

Das veröffentlichte Docker-Hub-Image ist für `linux/amd64` und `linux/arm64` verfügbar.
...
Ein lokaler Image-Build ist für den normalen Betrieb nicht mehr erforderlich.
...
```bash
docker compose -f /volume2/docker/schulmanager-homework-watcher/docker-compose.yaml pull
docker compose -f /volume2/docker/schulmanager-homework-watcher/docker-compose.yaml up -d
```
